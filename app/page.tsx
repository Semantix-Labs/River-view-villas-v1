    ...
    <div style={{ background: 'var(--cream)' }}>
      ...
      <section className="section-pad" style={{ background: 'var(--cream)' }}>
        <div className="container-rv">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '80px', alignItems: 'center' }}>
            ...
            <FadeIn delay={0.2}>
              <div style={{
                background: 'linear-gradient(145deg, #354024 0%, #1A2810 55%, #2C2016 100%)',
                borderRadius: '4px',
                overflow: 'hidden',
                aspectRatio: '4/5',
                display: 'flex',
                ...
                <div style={{ position: 'absolute', top: '40px', right: '40px', width: '80px', height: '80px', borderRadius: '50%', border: '1px solid rgba(201,169,110,0.25)' }} />
                <div style={{ position: 'absolute', top: '28px', right: '28px', width: '104px', height: '104px', borderRadius: '50%', border: '1px solid rgba(201,169,110,0.12)' }} />
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
                  {[
                    ...
                    <div key={stat.label}>
                      <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '38px', fontWeight: 600, color: 'var(--gold)', lineHeight: 1 }}>{stat.num}</p>
                      <p style={{ fontFamily: 'Jost, sans-serif', fontSize: '11px', color: 'rgba(247,243,238,0.55)', letterSpacing: '0.08em', textTransform: 'uppercase', marginTop: '8px' }}>{stat.label}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="section-pad" style={{ background: 'var(--cream)' }}>
        <div className="container-rv">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2px', marginBottom: '48px' }}>
            {treatments.map((t, i) => (
